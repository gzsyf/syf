/*******************************************************************
********************************************************************
STM32C8T6 NRFL2401 2.4G透传制文件 -- 24l01.c
io口的连接方式:
PB0-CE  PB1-CSN  PA4-IRQ  PA5-CLK  PA6-MISO  PA7-MOSI
*******************************************************************
*******************************************************************/
#include "24l01.h"
#include "spi1.h"
...
//-------------------初始化24L01的IO口---------------------------
//io口对应位置: PB0-CE  PB1-CSN  PA4-IRQ  PA5-CLK  PA6-MISO  PA7-MOSI
//----------------------------------------------------------------
...
{ 	
	...
	//PB0-CE  PB1-CSN  PA4-IRQ
	RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOB, ENABLE);	 
    	
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_0|GPIO_Pin_1;	//PF8 9 推挽 
...
u8 NRF24L01_TxPacket(u8 *txbuf)
{
	u8 sta;   
	NRF24L01_CE=0;
     NRF24L01_Write_Buf(NRF_WRITE_REG + RX_ADDR_P0, (u8*)TX_ADDRESS, TX_ADR_WIDTH);    // 装载帧头（对方的）地址    
