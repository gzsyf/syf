...
% constructs a cylinder connecting two center points 
% Parameters:
%	* X1, X2: 3x1 vectors of the two points
%	* r: radius of the cylinder
%   * n: no. of elements on the cylinder circumference (more--> refined)
%   * cyl_color: color definition like 'r','b',[0.52 0.52 0.52]
...
% Example:
%		>> [Cylinder EndPlate1 EndPlate2] =
%		cylinder3([10 10 10],[10 10 40],1,20,'r',1,1);
